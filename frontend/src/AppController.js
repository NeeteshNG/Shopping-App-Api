...
const useAppController = () => {
  ...
  const fetchWishlistProducts = useCallback(
    async products => {
      try {
        ...
        const response = await axios.get(
          `${API_URL}/wishlistApi/wishlist-items/`,
          {
            headers: {
              Authorization: `Token ${token}`
            }
  ...
  const removeItemFromCart = async productId => {
    try {
      ...
      await axios.delete(
        `${API_URL}/cartApi/cart-items/${cartItemId}/`,
        {
          method: 'DELETE',
          headers: {
            Authorization: `Token ${token}`
  ...
  const incrementCartItemQuantity = async productId => {
    try {
      ...
      const incrementResponse = await fetch(
        `${API_URL}/cartApi/cart-items/${cartItemId}/increment/`,
        {
          method: 'PATCH',
          headers: {
            Authorization: `Token ${token}`,
  ...
  const decrementCartItemQuantity = async productId => {
    try {
      ...
      const decrementResponse = await fetch(
        `${API_URL}/cartApi/cart-items/${cartItemId}/decrement/`,
        {
          method: 'PATCH',
          headers: {
            Authorization: `Token ${token}`,
  ...
  const toggleWishlist = async product => {
    ...
    try {
      const response = await axios.get(
        `${API_URL}/wishlistApi/wishlist-items/?user=${user?.id}&product=${product.id}`,
        {
          headers: {
            Authorization: `Token ${token}`
          }
      ...
      if (wishlistItemProductId.includes(product.id)) {
        ...
        await axios.delete(
          `${API_URL}/wishlistApi/wishlist-items/delete/${wishlistItemId}/`,
          {
            headers: {
              Authorization: `Token ${token}`
            }
